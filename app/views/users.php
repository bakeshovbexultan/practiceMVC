                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                        ...
                                        <?php
                                            if ($isAdmin || $editorName == $user['username']) {
                                        ?>
                                    ...
                                    <div class="dropdown-menu">
                                        <!-- edit?id= -->
                                        <a class="dropdown-item" href="page_edit<?php echo $user['id']; ?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="page_security<?php echo $user['id']; ?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="page_status_edit<?php echo $user['id']; ?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="page_media<?php echo $user['id']; ?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="delete_profile<?php echo $user['id']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
